...
checkGameMoveIsOver(){
  ...
  isGameOver(){
    if(this.games[0].mark !="" && this.games[0].mark===this.games[1].mark &&
    ...
    if(this.games[3].mark!="" && this.games[3].mark===this.games[4].mark &&
    ...
    if(this.games[6].mark!="" && this.games[6].mark===this.games[7].mark &&
    ...
    if(this.games[0].mark!="" && this.games[0].mark===this.games[3].mark &&
    ...
    if(this.games[1].mark!="" && this.games[1].mark===this.games[4].mark &&
    ...
    if(this.games[2].mark!="" && this.games[2].mark===this.games[5].mark &&
    ...
    if(this.games[0].mark!="" && this.games[0].mark===this.games[4].mark &&
    ...
    if(this.games[2].mark!="" && this.games[2].mark===this.games[4].mark &&
